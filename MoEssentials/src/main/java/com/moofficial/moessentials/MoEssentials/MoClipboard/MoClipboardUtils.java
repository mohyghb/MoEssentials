package com.moofficial.moessentials.MoEssentials.MoClipboard;
...
public class MoClipboardUtils {
    ...
    public static void add(Context c, String text){
        addClipBoardText((ClipboardManager) c.getSystemService(Context.CLIPBOARD_SERVICE), text,c,WAS_COPIED);
    }
