...
public class MoSelectableUtils {
     ...
     * to max alpha with with the color that is passed in
     ...
     */
    public static void applySelectedColor(Context c, View v, MoSelectableItem selectableItem, @ColorRes int selectedColorRes) {
        applySelectedColor(c, v, selectableItem, selectedColorRes, 255, R.color.transparent, 0);
    }
