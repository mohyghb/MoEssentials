package com.moofficial.moessentials.MoEssentials.MoUI.MoView.MoViews.MoSwitchers;
...
public class MoSectionViewManager {
    ...
    public Integer getActiveSectionKey() {
        return activeSection.first;
    }

    public View[] getActiveSectionViews() {
        return activeSection.second;
    }
